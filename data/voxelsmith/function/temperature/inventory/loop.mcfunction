...
function voxelsmith:temperature/inventory/modify_slot with storage voxelsmith:temperature

scoreboard players add #index voxelsmith.value 1
execute if score #index voxelsmith.value < #length voxelsmith.value run function voxelsmith:temperature/inventory/loop