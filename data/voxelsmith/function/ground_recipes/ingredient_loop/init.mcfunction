...
$execute as @e[type=item,nbt={Item:$(item)}] at @s if block ~ ~-0.1 ~ $(block) store result score #success voxelsmith.value run function voxelsmith:ground_recipes/ingredient_loop/loop
