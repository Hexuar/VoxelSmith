...
$execute store result score #temperature voxelsmith.value run data get entity @e[type=item,nbt={Item:$(item)},distance=..1,sort=nearest,limit=1] Item.components.minecraft:custom_data.voxelsmith.temperature
