execute if score #index voxelsmith.value >= #length voxelsmith.value run return 0
    ...
    function voxelsmith:smithing/start/set_material_properties with storage voxelsmith:smithing materials[0]
...
function voxelsmith:smithing/start/material_loop