# Kill ingots
execute as @e[type=marker,tag=voxelsmith.metal_shape,tag=!voxelsmith.knapping_shape] at @s unless block ~ ~-1 ~ #anvil run function voxelsmith:metal_shape/kill
execute as @e[type=marker,tag=voxelsmith.knapping_shape] at @s unless block ~ ~-1 ~ #voxelsmith:knapping_surface run function voxelsmith:metal_shape/kill
