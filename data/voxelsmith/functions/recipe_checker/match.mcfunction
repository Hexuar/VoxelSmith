...
data modify entity @e[type=item,sort=nearest,limit=1] Item.components.minecraft:custom_data.voxelsmith.temperature set from entity @e[type=marker,tag=voxelsmith.metal_shape,sort=nearest,limit=1] data.temperature
