...
data modify entity @e[type=item,sort=nearest,limit=1] Item.tag.voxelsmith.too_hot set value 1b
data modify entity @e[type=item,sort=nearest,limit=1] Item.tag.voxelsmith.no_temperature_model set value 1b
