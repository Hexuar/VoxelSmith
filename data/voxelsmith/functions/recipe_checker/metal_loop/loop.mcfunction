execute if score #metal_index voxelsmith.value >= #metal_length voxelsmith.value run return 0
    ...
    data modify storage voxelsmith:input metal set from storage voxelsmith:smithing recipes[0].metals[0].item
    function voxelsmith:recipe_checker/compare_metal
