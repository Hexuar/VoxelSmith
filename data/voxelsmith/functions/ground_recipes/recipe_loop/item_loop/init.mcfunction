...
$execute as @e[type=item,nbt={Item:$(item)}] at @s if block ~ ~-1 ~ $(block) store result score #success voxelsmith.value run function voxelsmith:ground_recipes/recipe_loop/item_loop/loop
