...
execute if score #temperature_model voxelsmith.value matches 1 run execute store result entity @s Item.tag.CustomModelData int 1 run scoreboard players get #CustomModelData voxelsmith.value
