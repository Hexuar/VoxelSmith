...
execute if score #temperature voxelsmith.value matches 40.. run function voxelsmith:ground_recipes/failed
execute if score #temperature voxelsmith.value matches 40.. run return 0
