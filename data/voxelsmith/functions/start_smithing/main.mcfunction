...
execute if block ~ ~-1 ~ #anvil[facing=north] positioned ~0.09375 ~ ~-0.28125 rotated 90 0 run function voxelsmith:voxel_shape/summon
execute if block ~ ~-1 ~ #anvil[facing=east] positioned ~-0.28125 ~ ~-0.09375 rotated 0 0 run function voxelsmith:voxel_shape/summon
execute if block ~ ~-1 ~ #anvil[facing=south] positioned ~0.09375 ~ ~-0.28125 rotated 90 0 run function voxelsmith:voxel_shape/summon
execute if block ~ ~-1 ~ #anvil[facing=west] positioned ~-0.28125 ~ ~-0.09375 rotated 0 0 run function voxelsmith:voxel_shape/summon

execute if block ~ ~-1 ~ #voxelsmith:knapping_surface positioned ~-0.28125 ~ ~-0.09375 rotated 0 0 run function voxelsmith:voxel_shape/summon
