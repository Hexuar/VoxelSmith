...
execute as @e[type=item_display,tag=voxelsmith.store_data_next_tick] at @s run function voxelsmith:metal_shape/store_data
execute as @e[type=item_display,tag=voxelsmith.store_data_next_tick] at @s run function voxelsmith:metal_shape/kill_far_voxels
