...
execute store result storage voxelsmith:smithing/data Damage int 1 run scoreboard players get #current_damage voxelsmith.value
item modify entity @s weapon.mainhand voxelsmith:smithing/copy_damage