...
data modify entity @e[type=item_display,tag=voxelsmith.metal_voxel,tag=voxelsmith.new,sort=nearest,limit=1] item set from storage voxelsmith:smithing/data metal

execute as @e[type=interaction,tag=voxelsmith.metal_voxel,tag=voxelsmith.new,sort=nearest,limit=1] run function voxelsmith:smithing/metal_voxel/store_pos
