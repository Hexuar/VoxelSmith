execute if entity @e[type=interaction,tag=voxelsmith.metal_voxel,tag=!voxelsmith.check_next_tick,sort=nearest,limit=1,distance=..0.03125] run function voxelsmith:smithing/hammer/voxel_update/move_up
...
schedule function voxelsmith:smithing/metal_shape/store_data_next_tick 1t
