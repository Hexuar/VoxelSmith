data remove storage voxelsmith:smithing/data shape
...
execute as @e[type=interaction,tag=voxelsmith.metal_voxel,tag=voxelsmith.current_ingot] run function voxelsmith:smithing/metal_shape/store_data/get_limits
...
function voxelsmith:smithing/recipe_checker/recipe_loop/init
schedule function voxelsmith:smithing/metal_shape/kill_next_tick 1t